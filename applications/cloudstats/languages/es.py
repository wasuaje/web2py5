...
'aplicacion para consumir el API de Cloudflare visible publicamente': 'aplicacion para consumir el API de Cloudflare visible publicamente',
'appadmin': 'appadmin',
...
'Errors': 'Errors',
'errors': 'errores',
'Estadisticas del CDN Cloudflare': 'Estadisticas del CDN Cloudflare',
...
'Nombre de archivo a purgar: http://cdn.eluniversal.com/': 'Nombre de archivo a purgar: http://cdn.eluniversal.com/',
...
'views': 'vistas',
'Views': 'Vistas',
'visor de las estadisticas de Cloudflare': 'visor de las estadisticas de Cloudflare',
